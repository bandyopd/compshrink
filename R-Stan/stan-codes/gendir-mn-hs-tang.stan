...
// ** New version - models GDM parameters as mu & sigma - log-linear **
// ** Similar to ZhengZheng Tang's ZIGDM model hierarchy**
// ** Very, very slow, possibly due to complicated posterior geometry**
//
