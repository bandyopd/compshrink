...
parameters {
  ...
  matrix<lower=0>[ncolX,ncolY] eta_tilde; // truncated local shrinkage
...
transformed parameters{
  ...
  matrix<lower=0>[ncolX,ncolY] eta; // extra local shrinkage
    
  eta = diag_post_multiply(eta_tilde, tau);
  lambda = lambda_tilde .* eta;
